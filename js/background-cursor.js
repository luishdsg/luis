...
(function(w) {
    ...
    var num_cols = 5000 / resolution; //This value is the number of columns in the grid.
    var num_rows = 5000 / resolution; //This is number of rows.
    var speck_count = 80000; //This determines how many particles will be made.
    ...
    function init() {
        ...
        */
        for (i = 0; i < speck_count; i++) {
            ...
            */
            particles.push(new particle(Math.random() * 5000, Math.random() * 5000));
        }
        ...
        for (i = 0; i < particles.length; i++) {
            ...
            if (p.x >= 0 && p.x < 5000 && p.y >= 0 && p.y < 5000) {
                ...
                */
                ...
                p.x = p.px = Math.random() * 5000;
                p.y = p.py = Math.random() * 5000;
